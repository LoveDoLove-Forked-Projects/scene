...
class SuppressLayoutChangeBounds : ChangeBounds() {
    override fun onStart(animationView: View) {
        super.onStart(animationView)
        if (animationView.parent is ViewGroup) {
            val parent = animationView.parent as ViewGroup
            SceneViewCompatUtils.suppressLayout(parent, true)
        }
    }

    override fun onFinish(animationView: View) {
